...
export const INITIAL_CUTTING_ENTRIES: CuttingEntry[] = [
  {
    ...
    cut_type: 'bulk',
    pieces_cut: 18000,
    tables_layers: 'Table 1, 120 layers',
    worker_id: 'b1111111-1111-1111-1111-111111111109',
    notes: 'Front, back and sleeve bulk panel cutting complete',
  ...
  },
  {
    ...
    cut_type: 'sample',
    pieces_cut: 15,
    tables_layers: 'Sample Table A',
    worker_id: 'b1111111-1111-1111-1111-111111111109',
    notes: 'PP sample pieces cut for approval batch',
  ...
  },
  {
    ...
    cut_type: 'bulk',
    pieces_cut: 3500,
    tables_layers: 'Table 2, 80 layers',
    worker_id: 'b1111111-1111-1111-1111-111111111110',
    notes: 'Denim jacket body panels bulk cut',
    created_at: '2026-07-30T14:00:00Z',
  },
  {
    id: 'cut-104',
    entry_date: '2026-07-25',
    style_id: 'a4444444-4444-4444-4444-444444444444',
    cut_type: 'bulk',
    pieces_cut: 5000,
    tables_layers: 'Table 3, 100 layers',
    worker_id: 'b1111111-1111-1111-1111-111111111110',
    notes: 'Polo order 100% bulk cutting finished',
...
export const INITIAL_SAMPLES: GarmentSample[] = [
  {
    ...
    buyer_feedback: 'Fit and construction approved. Clear for bulk cutting.',
    photo_url: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&auto=format&fit=crop&q=80',
    notes: 'Pre-production sample sign-off by Apex QC team',
  ...
  },
  {
    ...
    qty: 4,
    size: 'L',
    colour: 'Dark Indigo Wash',
    requested_date: '2026-07-15',
    submitted_date: '2026-07-25',
    buyer_feedback: 'Submitted to Nordic HQ for wash fastness approval.',
    photo_url: 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?w=400&auto=format&fit=crop&q=80',
    notes: 'Pending buyer PP sign-off (Notice: Bulk cutting started!)',
    created_at: '2026-07-15T11:00:00Z',
  },
  {
    id: 'smp-103',
    style_id: 'a3333333-3333-3333-3333-333333333333',
    sample_type: 'Proto',
    status: 'Approved',
    qty: 2,
    size: 'S',
    ...
    buyer_feedback: 'Initial proto sample pattern approved.',
    photo_url: 'https://images.unsplash.com/photo-1564257631407-4deb1f99d992?w=400&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    submitted_date: null,
    buyer_feedback: 'Sample department preparing PP sample cut.',
  ...
  },
  {
    ...
    buyer_feedback: '100% Approved by H&M Merchandiser',
    photo_url: 'https://images.unsplash.com/photo-1625910513413-5fc28122d4f2?w=400&auto=format&fit=crop&q=80',
